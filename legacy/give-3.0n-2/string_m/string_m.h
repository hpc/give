...
extern errno_t cstrcpy_m(string_m s1, char *s2);
extern errno_t wstrcpy_m(string_m s1, wchar_t *s2);

extern errno_t strncpy_m(string_m s1, const string_m s2, size_t nchar);
extern errno_t cstrncpy_m(string_m s1, char *s2, size_t nchar);
extern errno_t wstrncpy_m(string_m s1, wchar_t *s2, size_t nchar);
...
extern errno_t strspn_m(string_m str, string_m accept, rsize_t *len);

extern errno_t cstrspn_m(string_m str, const char *accept, rsize_t *len);
extern errno_t wstrspn_m(string_m str, const wchar_t *accept, rsize_t *len);

extern errno_t strcspn_m(string_m str, string_m accept, rsize_t *len);
extern errno_t cstrcspn_m(string_m str, const char *accept, rsize_t *len);
extern errno_t wstrcspn_m(string_m str, const wchar_t *accept, rsize_t *len);
...
extern errno_t cstrcat_m(string_m s1, char *s2);
extern errno_t wstrcat_m(string_m s1, wchar_t *s2);
